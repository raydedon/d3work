...
// Node/CommonJS - require D3
    ...
    rc.models.combinedChart = function(obj) {
        var breakPoint = 768,
            ...
            chartContainerInnerWidth, chartPlotAreaInnerWidth, svg, margin, width, height, innerHeight, metadata = obj.metadata;
        ...
        function groupNAggregateNSortJSONData(issuesRawData) {
            ...
            return [{key: 'C1', values: seriesData}, {key: 'C2', values: seriesData2}];
        }

        function configureLeftAxisScale(ticksArray) {
            var minValue = d3.min(ticksArray.filter(function(d) {
                return !d.invisible;
            }), function(c) {
